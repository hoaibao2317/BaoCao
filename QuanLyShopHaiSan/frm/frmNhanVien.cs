...
namespace QuanLyShopHaiSan.frm
{
    public partial class frmNhanVien : Form
    {
        ...
        {
            string sql;
            sql = "SELECT MaNhanVien,TenNhanVien,GioTinh,DiaChi,DienThoai,NgaySinh FROm tblNhanVien";
        ...
        private void dgvNhanVien_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvNhanVien.CurrentRow.Cells["GioTinh"].Value.ToString() == "Nam") chkGioTinh.Checked = true;
            else chkGioTinh.Checked = false;
        ...
        {
            {
                ...
                sql = "INSERT INTO tblNhanVien(MaNhanVien,TenNhanVien,GioTinh, DiaChi,DienThoai, NgaySinh) VALUES (N'" + txtMaNhanVien.Text.Trim() + "',N'" + txtTenNhanVien.Text.Trim() + "',N'" + gt + "',N'" + txtDiaChi.Text.Trim() + "','" + txtDienThoai.Text + "','" + Functions.ConvertDateTime(mskNgaySinh.Text) + "')";
        ...
        private void btnSuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblNhanVien SET  TenNhanVien=N'" + txtTenNhanVien.Text.Trim().ToString() +
                    ...
                    "',DienThoai='" + txtDienThoai.Text.ToString() + "',GioTinh=N'" + gt +
